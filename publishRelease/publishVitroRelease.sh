...
ECHO ">>>" mvn release:perform -Dgoals=deploy -Darguments="-Dcheckstyle.skip=true -Dmaven.deploy.skip=false -Dmaven.test.skip=true"
...
curl -H "Authorization: Bearer ${PERSONAL_ACCESS_TOKEN}"\
	--data '{"tag_name": "'${Vitro_TAG}'-'${RC_VERSION}'",
                "target_commitish": "'${BRANCH}'",
                "name": "Release '${Vitro_TAG}'-'${RC_VERSION}'",
                "body": "**Release '${Vitro_TAG}' '${RC_VERSION}'**<br/>It is recommended that you review the '${RC_VERSION_MINOR}' Documentation and the VIVO/Vitro READMEs on github before you start.<br/>If you are new to VIVO/Vitro it is suggested that you take advantage of Docker/Docker-Compose.  The instructions are shown in the VIVO README.md on github.<br/><br/>**VIVO '${RC_VERSION_MINOR}'.x Documentation**<br/>https://wiki.lyrasis.org/display/VIVODOC'${RC_VERSION_MINOR//.}'x/<br/>https://github.com/vivo-project/VIVO/releases/tag/vivo-'${RC_VERSION}'<br/>https://github.com/vivo-project/Vitro/releases/tag/vitro-'${RC_VERSION}'<br/><br/>**Release Notes**<br/>https://wiki.lyrasis.org/display/VIVODOC'${RC_VERSION_MINOR//.}'x/Release+Notes<br/><br/>**Release Testing**<br/>https://wiki.lyrasis.org/display/VIVO/Release+Testing+-+'${RC_VERSION}'<br/><br/>**Previous Release Announcements**<br/>https://wiki.lyrasis.org/display/VIVO/Releases",
                "draft": false,
                "prerelease": false,
                "generate_release_notes":true}' \
    https://api.github.com/repos/${ORG}/${Vitro_REPO}/releases
